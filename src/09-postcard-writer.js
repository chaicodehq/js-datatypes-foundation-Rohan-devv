...
//  *      - Example: formatPostcardField("To", "Dadi ji", 8) => "To      : Dadi ji"
    ...
    const finalWidth = typeof width === "number" && width && width > 0 ? width : 12
...
//  *      - Example: isFromState("Priya, Mumbai, MH", "UP") => false
    ...
    endsWith(stateCode.trim().toUpperCase())
}
...
//  *      - Example: countVowels("Namaste India") => 6
     ...
     const matches = message.match(/[aeiouAEIOU]/g)  // Regex ko quotes me nahi likhte.
