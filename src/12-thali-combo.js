...
Ye kaam nahi karega, kyunki:

filter() ko boolean chahiye

Object truthy hota hai → to saare elements pass ho jayenge

Aur result me original array hi aa jayega 😅
     */
...
//  *
    ...
    Extra Knowledge (Interview Level)

Internally:

Array.includes() → strict equality check karta hai

String.includes() → substring search karta hai
